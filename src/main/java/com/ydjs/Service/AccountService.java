 ...
 * Responsible for handling all business logic, validation, and passing valid data to the Data Access Layer.
 * 
...
public class AccountService {
     ...
     * @return The registered Account object containing the generated account_id, or null if validation fails.
     */
     ...
     * @return The authenticated Account object with its account_id if successful, or null if login fails.
     */
     ...
     * This is generally used as a helper method for validating message creation.
     * 
     * Implements specification:
     * - System Doc Section 3.1 (Helper validation).
     * 
